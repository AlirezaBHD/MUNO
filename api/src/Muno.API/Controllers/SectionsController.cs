...
namespace Muno.API.Controllers
{
    ...
    public class SectionsController(ISectionService sectionService) : ControllerBase
    {
        ...
        {
            var section = await sectionService.CreateSectionAsync(categoryId: categoryId,
        ...
        {
            var section = await sectionService.GetSectionByIdAsync(sectionId: id);
            return Ok(section);
        }
        ...
        {
            await sectionService.DeleteSectionAsync(id: id);
            return NoContent();
        }
        ...
        {
            await sectionService.UpdateSectionAsync(id: id, categoryId: categoryId, dto: updateSectionRequest);
            return NoContent();
        }
        ...
        {
            var categories = await sectionService.GetSectionListAsync();
        ...
        {
            await sectionService.UpdateSectionOrderAsync(dto);
            return NoContent();
        }
    }
}